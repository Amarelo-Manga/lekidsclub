...
add_action( 'init', 'category_parcerias_taxonomies', 1 );

function category_parcerias_taxonomies() {
	...
	$args = array(
		...
		'query_var'         => true,
		'rewrite'           => array( 'slug' => 'category_parcerias' ),
	);

	register_taxonomy( 'category_parcerias', array( 'parcerias' ), $args );
}