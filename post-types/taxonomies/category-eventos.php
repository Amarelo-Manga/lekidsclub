...
add_action( 'init', 'category_eventos_taxonomies', 1 );

function category_eventos_taxonomies() {
	...
	$args = array(
		...
		'query_var'         => true,
		'rewrite'           => array( 'slug' => 'category_eventos' ),
		'show_in_nav_menus' => false,
	);

	register_taxonomy( 'category_eventos', array( 'eventos' ), $args );
}